...
<?php if(Auth::user()->role == 'admin'): ?>
    ...
    <head>
        ...
        <link href="<?php echo e(URL::asset('css/styles_admin.css')); ?>" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href=" <?php echo e(route('admin')); ?>">Rent a Car</a>
            <!-- Sidebar Toggle-->
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($car->licence_plate); ?></td>
                                            <td><?php echo e($car->gps == 1 ? 'yes' : 'no'); ?></td>
                                            <td hidden><?php echo e($car->id); ?></td>
                                            <td>
                                                <form action=<?php echo e('/admin/newcars/delete', $car->id); ?> method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" value="<?php echo e($car->id); ?>"
                            ...
                            <form action="/admin/newcars/update" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="category">
                                        <?php $__currentLoopData = $car_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="gps">
                                        <?php $__currentLoopData = $has_gps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option> <?php echo e($gps == 1 ? 'has gps' : 'no gps'); ?></td>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
        ...
        <script type="text/javascript" src="<?php echo e(URL::asset('js/datatables-simple-demo.js')); ?>"></script>
...
<?php /**PATH /home/aimane/Documents/oefenexamen (Bit Academy)/Rent-a-Car---Realisatie-014d3643-3aa27aff/rentacar/resources/views/admin_edit_cars.blade.php ENDPATH**/ ?>